...
const sheetVariants = cva(
  "fixed z-50 gap-4 bg-background p-6 shadow-lg transition data-[state=closed]:duration-200 data-[state=open]:duration-250 data-[state=open]:ease-out data-[state=closed]:ease-in data-[state=open]:animate-in data-[state=closed]:animate-out",
  {
    variants: {
      side: {
